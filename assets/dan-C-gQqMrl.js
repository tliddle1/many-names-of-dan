import{a as e,i as t}from"./shapes-DyW1ToKl.js";var n=`#b8a04c`;function r(e){return`<g>
    ...
    <path d="M${e-10},27 L${e-8},21" stroke="#8a7a30" stroke-width="1" stroke-linecap="round"/>
      ...
      </g>`]},cosmic:{shirtColor:`#1a0a3e`,headColor:`#e8beac`,accents:e=>[t(e-10,65,2,`#FFD700`),t(e+8,72,1.5,`#00E5FF`),t(e-5,78,1,`#7C4DFF`),t(e+12,68,1.5,`#FFD700`),`<polygon points="${e-18},54 ${e},48 ${e+18},54" fill="#311B92"/>`]},medieval:{shirtColor:`#5d4037`,headColor:`#e8beac`,accents:t=>[`<polygon points="${t-12},26 ${t-8},16 ${t-4},23 ${t},12 ${t+4},23 ${t+8},16 ${t+12},26" fill="#FFC107" stroke="#DAA520" stroke-width="0.5"/>`,e(t-14,72,28,4,`#8b6914`),e(t-3,71,6,6,`#FFC107`,1)]},fist:{shirtColor:`#1a1a1a`,headColor:`#e8beac`,accents:e=>[`<g transform="translate(${e+22}, 50)">
